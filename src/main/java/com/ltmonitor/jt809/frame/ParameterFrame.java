 ...
 public class ParameterFrame extends JDialog
 {
   ...
   private void initParameter() {
	   ParameterModel pm = GlobalConfig.parModel;
	     ...
	     this.platPassword.setText(pm.getPlatformPassword());
	     this.platUsername.setText(String.valueOf(pm.getPlatformUserId()));
   ...
   private void initComponents()
   {
     ...
     this.jLabel1.setText("监管平台端口：");
     
     this.jLabel2.setText("平台接入码：");
 
     this.jLabel3.setText("监管平台IP ：");
 
     this.jLabel4.setText("登录密码：");
 
     this.jLabel5.setText("登录账号：");
 
     this.jLabel6.setText("本地平台端口：");
   ...
   private void saveButtonActionPerformed(ActionEvent evt)
   {
	   ...
	   pm.setUsername(this.usernameText.getText());
	   pm.setPlatformUserId(Integer.parseInt(this.platUsername.getText()));
	   pm.setPlatformPassword(this.platPassword.getText());
	   pm.setPlatformCenterId(Long.parseLong(this.platID.getText()));
	   pm.setMiyaoA(Long.parseLong(this.miyaoIA1.getText()));
	   pm.setMiyaoM(Long.parseLong(this.miyaoM1.getText()));
	   pm.setMiyaoC(Long.parseLong(this.miyaoIC1.getText()));
	   
	   GlobalConfig.parModel = (pm);
