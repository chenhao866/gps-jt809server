...
public class ControlFrame extends JFrame {
	...
	private void initComponents() {
		...
		txtAlarmId = new JTextField();
		txtAlarmId.setText("1");
		txtAlarmId.setColumns(10);
		
		
		JLabel lblNewLabel = new JLabel("\u8F66\u724C\u53F7");
		
		JLabel label = new JLabel("\u8F66\u724C\u989C\u8272");
		JLabel lblAlarmId = new JLabel("报警ID");
		...
		buttonSendHistoryLocation.setText("时效口令上报");
				...
				.addGroup(layout.createSequentialGroup()
					...
					.addGroup(layout.createParallelGroup(Alignment.LEADING)
						.addGroup(layout.createSequentialGroup()
							...
							.addGap(10)
							.addComponent(lblAlarmId)
							.addGap(18)
							.addComponent(txtAlarmId, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
							)							
	...
	private void sendHistoryLocation(ActionEvent evt){
		...
		Boolean res = T809Manager.UpAuthorizeMsgStartUp();
		/**
		//模拟五条定位数据
	...
	private void sendWarnInfo(ActionEvent evt)
	{
		...
		wd.setType(WarnData.EMERGENCY);
		infoId=Integer.parseInt(this.txtAlarmId.getText());
		wd.setInfoId(infoId);
