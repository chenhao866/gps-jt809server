 ...
 *
 */
public class UpWarnMsgCheckAck_Subiao implements ISendProtocol {
	private static Logger logger = Logger.getLogger(UpWarnMsgCheckAck_Subiao.class);
	private AdasWarnData wd;

	private int msgType = 0x1400;
	private int subType = 0x1405;
	public UpWarnMsgCheckAck_Subiao(AdasWarnData wd) {
		this.wd = wd;
	}
