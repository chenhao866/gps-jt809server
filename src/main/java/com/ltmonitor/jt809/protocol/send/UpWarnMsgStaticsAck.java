 ...
 *
 */
public class UpWarnMsgStaticsAck implements ISendProtocol {
	private static Logger logger = Logger.getLogger(UpWarnMsgStaticsAck.class);
	...
	public UpWarnMsgStaticsAck(String _plateNo, int _plateColor, List<AdasWarnStaticsItem> wd) {
	...
	public JT809Message wrapper() {
		...
		{
			sb.append(Tools.ToHexString(s.getWarnType(), 2))
