...
public class UpExgMsgRegister implements ISendProtocol {
	...
	public JT809Message wrapper() {
		...
		sb.append(vehicleModel.getPlateformId()).append(",")
		.append(vehicleModel.getTerminalVendorId()).append(",")
		.append(vehicleModel.getTerminalModel()).append(",")
		.append(vehicleModel.getTerminalId()).append(",")
		.append(vehicleModel.getSimNo()).append(",");
