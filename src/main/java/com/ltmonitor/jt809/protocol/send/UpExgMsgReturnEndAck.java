...
public class UpExgMsgReturnEndAck implements ISendProtocol {
	private static Logger logger = Logger
			.getLogger(UpExgMsgReturnEndAck.class);
	private int msgType = 0x1200;
	private int subType = 0x1206;
	private String plateNo;
	private int plateColor;

	public UpExgMsgReturnEndAck(String plateNo, int plateColor) {
